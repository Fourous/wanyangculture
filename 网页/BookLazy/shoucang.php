...
<?php
	...
	$comment_count = mysqli_num_rows($rs);
	$page_count = (int)(($comment_count-1)/$pagesize + 1);
	...
	$sql = "SELECT book_comment.*,book.bookname
			FROM book_comment
			JOIN book
			ON book_comment.bookid = book.bookid
			WHERE uid = {$uid}
			ORDER BY bookid 
...
?>
        ...
        <div class="gz_content">
            <div class="gz_nr">
                <div class="title">
                    <span class="lei">全部收藏</span>
                    <span class="num"><?php echo $comment_count ?></span>
                </div>
                <div class="nr">
				...
				<tr>
					...
					<td width="11%" align="center" bgcolor="#FFFFFF">评论</td>
				</tr>
<?php
...
?>
				<tr align="center">
					...
					<td class="td_bg" width="11%" height="26"><?php echo $rows["comment"]?></td>
...
?>
	&nbsp;页次：<?php echo $page_now ?>/<?php echo $page_count ?>页&nbsp;共有<?php echo $comment_count?>条信息 </th>
	  </tr>
                </div>
            </div>
        </div>
